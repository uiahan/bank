            ...
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <h3 class="fw-bold text-secondary">Buat Pinjaman</h3>
                    </div>
                    <div class="col-6 d-none d-md-block">
                        <p class="text-muted text-end text-secondary">Peminjaman &gt; Dashboard &gt; Buat</p>
                    </div>
                </div>
            </div>
                ...
                <form action="/tambah-nasabah" method="POST" class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 mt-md-0 mt-2">
                            <label for="nominal" class="form-label">Total Pinjam</label>
                        ...
                        <div class="col-md-6 col-12 mt-2">
                            <label for="jumlah" class="form-label">Pokok Angsuran</label>
