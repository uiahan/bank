...
@section('title', 'Gunakan Simpanan Wajib')
@section('content')
    <div class="d-flex">
            ...
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <h3 class="fw-bold text-secondary">Gunakan Simpanan Wajib</h3>
                    </div>
                    <div class="col-6 d-none d-md-block">
                        <p class="text-muted text-end text-secondary">Simpanan Wajib &gt; Dashboard &gt; Gunakan</p>
                    </div>
                </div>
            </div>

            <div class="card p-4 shadow border-0 mt-4">
                <h5 class="fw-bold text-secondary">Data Simpanan Wajib</h5>
                <form action="/tambah-nasabah" method="POST" class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 mt-md-0 mt-2">
                            <label for="tgl_join" class="form-label">Rincian Pemakaian Simpanan Wajib</label>
                        ...
                        <div class="col-md-6 col-12 mt-2">
                            <label for="no_rek" class="form-label">Total Simpanan Wajib</label>
                            <input type="text" readonly class="form-control border-0" id="no_rek" name="no_rek" style="background-color: #ededed" required>
                        </div>
                        <div class="col-md-6 col-12 mt-2">
                            <label for="anggota" class="form-label">Sisa</label>
                            <input type="text" readonly class=" form-control border-0" style="background-color: #ededed" required>
                        </div>
                        <div class="col-md-6 col-12 mt-2">
                    ...
                    <a href="{{ route('simpananWajib') }}" class="btn btn-primary mt-3">Kembali</a>
                </form>                
            </div>
        </div>
