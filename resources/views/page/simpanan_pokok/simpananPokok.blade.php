    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5" id="printableArea">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Simpanan Pokok</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Simpanan Pokok &gt; Dashboard</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-nasabah count-card border-0 mt-4 shadow" style="background-color: #5692F9">
                <div class="row px-3 py-4">
                    ...
                    <div class="col-5 d-flex align-items-center" style="height: 100%;">
                        <i class='bx bx-wallet nav_icon text-white' style="font-size: 5rem"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                <div class="d-flex flex-column text-center flex-md-row align-items-center">
                    <h4 class="me-auto" style="color: #5692F9">Tabel Simpanan Pokok</h4>
                    <div class="d-flex">
                        <h4 class="ms-auto text-center me-2"><a href="{{ route('buatSimpananPokok') }}"
                                class="btn text-white rounded-5 btn-tambah-nasabah" style="background-color: #5692F9">
                                <i class="fa-solid fa-plus text-white me-1"></i> Buat Simpanan Pokok
                            </a>
                        </h4>
                        ...
                        <tbody style="background-color: #f2f2f2">
                            <tr>
                                ...
                                <td class="text-center align-middle" style="vertical-align: middle; white-space: nowrap;">
                                    <a href="{{ route('detailSimpananPokok') }}" class="btn btn-primary"
                                        style="padding: 12px 15px;" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Detail">
                                    ...
                                    <a href="{{ route('bayarSimpananPokok') }}" class="btn btn-success"
                                        style="padding: 12px 15px;" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Bayar">
                                        <i class="fa-regular fa-credit-card"></i>
                                    </a>
                                    <a href="{{ route('bayarAllSimpananPokok') }}" class="btn btn-success"
                                        style="padding: 12px 15px;" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Bayar All">
