...
@section('title', 'Bayar Simmpanan Pokok')
@section('content')
    <div class="d-flex">
            ...
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <h3 class="fw-bold text-secondary">Bayar Simpanan Pokok</h3>
                    </div>
                    <div class="col-6 d-none d-md-block">
                        <p class="text-muted text-end text-secondary">Simpanan Pokok &gt; Dashboard &gt; Bayar</p>
                    </div>
                </div>
            </div>
