...
@section('title', 'Detail Simpanan Sukarela')
@section('content')
    <div class="d-flex">
            ...
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <h3 class="fw-bold text-secondary">Detail Simpanan Sukarela</h3>
                    </div>
                    <div class="col-6 d-none d-md-block">
                        <p class="text-muted text-end text-secondary">Simpanan Sukarela &gt; Dashboard &gt; Detail</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-4 shadow border-0 mt-4" >
                ...
                <form action="" class="mt-2">
                    <div class="row">
                        ...
                        <!-- Status -->
                        <div class="col-xl-4 col-12 mt-2">
                            <label for="" class="form-label">Jasa Diterima</label>
    ...
    <div id="printableTable" style="display: none;" class="mt-5">
        ...
        <table id="hal-2" class="mt-5"> <!-- Add page break before this table -->
            <thead>
                <tr>
                    <th colspan="5" style="text-align: center; padding: 8px; background-color: #f2f2f2; border: 1px solid black;">Detail Simpanan Sukarela</th>
                </tr>
            </thead>
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid black; padding: 8px;">Jasa Diterima</th>
                </tr>
            </thead>
