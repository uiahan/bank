    ...
    <div class="d-flex">
        ...
        <div class="container mt-4 mt-md-5 py-5" id="printableArea">
            <div class="p-4 shadow card border-0">
                <div class="row">
                    <div class="col-6">
                        <h3 class="fw-bold text-secondary">Asuransi</h3>
                    </div>
                    <div class="col-6">
                        <p class="text-muted text-end text-secondary">Asuransi &gt; Dashboard</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-nasabah count-card border-0 mt-4 shadow" style="background-color: #5692F9">
                <div class="row px-3 py-4">
                    <div class="col-7 text-white">
                        <h5>Total Asuransi :</h5>
                        <h1 class="px-3">1</h1>
                    </div>
                    <div class="col-5 d-flex align-items-center" style="height: 100%;">
                        <i class='bx bx-shield nav_icon text-white' style="font-size: 5rem"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 mt-4 p-4 shadow">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center">
                    <h4 class="me-auto mb-3 mb-md-0" style="color: #5692F9">Tabel Asuransi</h4>
                    <h4 class="ms-md-auto me-md-3 mb-3 mb-md-0">
                        <a href="{{ route('tambahAsuransi') }}" class="btn text-white rounded-5 btn-tambah-nasabah" style="background-color: #5692F9">
                            <i class="fa-solid fa-plus text-white me-1"></i> Gunakan Asuransi
                        </a>
                    </h4>
                ...
                <div class="table-responsive">
                    <table class="table" id="example2">
                        ...
                        <tbody style="background-color: #f2f2f2">
                            <tr>
                                <th scope="row" style="vertical-align: middle;">1</th>
                                <td style="vertical-align: middle;">Lorem Ipsum</td>
                                <td style="vertical-align: middle;">13 Oktober 2024</td>
                                <td style="vertical-align: middle;">Rp100.000</td>
                                <td style="vertical-align: middle;">Tidak Ada</td>
                            </tr>
